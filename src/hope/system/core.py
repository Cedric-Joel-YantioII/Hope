"""HopeSystem — the fully wired system dataclass."""
...
if TYPE_CHECKING:
    ...
    from hope.channels._stubs import BaseChannel
    from hope.learning._stubs import RouterPolicy
    ...
    from hope.security.boundary import BoundaryGuard
    ...
    from hope.speech._stubs import SpeechBackend
...
class HopeSystem:
    ...
    def wire_channel(self, channel_bridge: Any) -> None:
        ...
        ----------
        channel_bridge:
            A connected :class:`~hope.channels._stubs.BaseChannel`
            instance whose ``on_message`` method accepts a callable.
        """
        from hope.core.types import Message
        from hope.sessions.session import SessionStore
