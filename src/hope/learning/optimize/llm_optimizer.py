"""LLM-based optimizer for Hope configuration tuning.

Uses a cloud LLM to propose optimal Hope configs, inspired by DSPy's
...
class LLMOptimizer:
    """Uses a cloud LLM to propose optimal Hope configs.
    ...
    def _build_initial_prompt(self) -> str:
        ...
        lines: List[str] = []
        lines.append("You are optimizing an Hope AI system configuration.")
        lines.append("")
    ...
    def _build_analyze_prompt(
        ...
        lines: List[str] = []
        lines.append("Analyze this Hope evaluation result.")
        lines.append("")
