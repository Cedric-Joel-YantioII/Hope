...
``~/.hope/learning/skills/<skill-name>/optimized.toml``.
...
from hope.core.types import Trace, TraceStep
from hope.skills.manager import SkillManager
from hope.skills.overlay import SkillOverlay, write_overlay
...
class SkillOptimizer:
    ...
    def _run_dspy(
        ...
        """
        from hope.core.config import DSPyOptimizerConfig
        from hope.learning.agents.dspy_optimizer import DSPyAgentOptimizer
    ...
    def _run_gepa(
        ...
        from hope.learning.agents.gepa_optimizer import GEPAAgentOptimizer
