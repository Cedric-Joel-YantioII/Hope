...
Adapted from IPW's ``environment.py``.  Uses Hope's
:class:`~hope.tools._stubs.ToolExecutor` for real tool dispatch
...
class OrchestratorEnvironment:
    """RL environment that executes tools via Hope ``ToolExecutor``.
