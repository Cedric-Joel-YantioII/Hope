...
def create_energy_monitor(
    ...
    try:
        from hope.telemetry.energy_nvidia import NvidiaEnergyMonitor
    ...
    try:
        from hope.telemetry.energy_amd import AmdEnergyMonitor
    ...
    try:
        from hope.telemetry.energy_apple import AppleEnergyMonitor
    ...
    try:
        from hope.telemetry.energy_rapl import RaplEnergyMonitor
