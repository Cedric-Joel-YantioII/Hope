"""ToolTranslator — translate external tool names to Hope equivalents.

External skill libraries (Hermes Agent, OpenClaw) reference tools by Claude
Code's standard tool names (Bash, Read, Write, etc.).  Hope uses
...
# ---------------------------------------------------------------------------
# Translation table — external name → Hope name
# ---------------------------------------------------------------------------
