...
Renamed from ``OpenHandsAgent`` to clarify this is Hope's native
...
from hope.core.types import Message, Role, ToolCall, ToolResult
from hope.engine._stubs import InferenceEngine
from hope.tools._stubs import BaseTool, build_tool_descriptions
