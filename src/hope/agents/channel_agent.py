...
Routes incoming :class:`~hope.channels._stubs.ChannelMessage` objects
...
from hope.channels._stubs import BaseChannel, ChannelMessage
...
_ESCALATION_TEMPLATE = "{preview}...\n\n---\nFull report ready — open in Hope:\nhope://research/{session_id}"
...
class ChannelAgent:
    ...
    agent:
        ...
        method (typically a :class:`~hope.agents._stubs.BaseAgent`
        subclass).
    max_workers:
