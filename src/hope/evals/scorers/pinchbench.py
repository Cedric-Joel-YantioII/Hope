...
Provides transcript translation (Hope events → PinchBench format),
...
from hope.evals.core.event_recorder import EventType
from hope.evals.core.scorer import LLMJudgeScorer
from hope.evals.core.types import EvalRecord

LOGGER = logging.getLogger(__name__)

# ---------------------------------------------------------------------------
# Tool name mapping: Hope name → PinchBench-expected name
# ---------------------------------------------------------------------------
...
def _tool_results_to_transcript(
    ...
    """Build transcript from HopeAgentBackend tool_results list."""
    transcript: List[Dict[str, Any]] = []
