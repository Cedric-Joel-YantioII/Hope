...
from hope.evals.core.export import _hardware_info_dict
from hope.evals.core.scorer import Scorer
from hope.evals.core.tracker import ResultTracker
...
try:
    from hope.telemetry.efficiency import compute_efficiency
except ImportError:  # pragma: no cover
    compute_efficiency = None  # type: ignore[assignment]

try:
    from hope.telemetry.efficiency import estimate_model_flops_per_token
except ImportError:  # pragma: no cover
...
class EvalRunner:
    ...
    def run(
        ...
        from hope.evals.core.dataset import DatasetProvider as _DP
