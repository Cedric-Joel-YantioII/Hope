"""High-level Python SDK for Hope."""
...
from hope.system import HopeSystem, SystemBuilder
...
class MemoryHandle:
    ...
    def __init__(self, config: HopeConfig) -> None:
        self._config = config
    ...
    def _get_backend(self) -> Any:
        ...
        if not MemoryRegistry.contains(key):
            ...
            try:
                from hope.tools.storage.sqlite import SQLiteMemory  # noqa: F401
            except ImportError:
                pass
    ...
    def index(
        ...
        *,
        ...
        from hope.tools.storage.chunking import ChunkConfig
...
class Hope:
    ...
    @property
    def config(self) -> HopeConfig:
        """Return the active configuration."""
        return self._config

    @property
    def version(self) -> str:
        """Return the Hope version string."""
        return hope.__version__
    ...
    def _run_agent(
        ...
        *,
        ...
        if tools:
            ...
            from hope.cli.ask import _build_tools
        ...
        if agent_name == "morning_digest" and hasattr(self._config, "digest"):
            ...
            from hope.tools.text_to_speech import TextToSpeechTool
        ...
        if context and self._config.agent.context_from_memory:
            try:
                from hope.cli.ask import _get_memory_backend
...
__all__ = ["Hope", "HopeSystem", "MemoryHandle", "SystemBuilder"]
