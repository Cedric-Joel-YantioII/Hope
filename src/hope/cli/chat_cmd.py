"""``hope chat`` — interactive multi-turn chat REPL."""
...
def chat(
    ...
    # Resolve engine
    from hope.engine import get_engine
    from hope.intelligence import register_builtin_models
    ...
    if agent_key and agent_key != "none":
        try:
            import hope.agents  # noqa: F401 — trigger registration
    ...
    # Print banner
    console.print(
        f"[green bold]Hope Chat[/green bold]\n"
