"""``hope optimize`` — LLM-driven configuration optimization CLI."""
...
def optimize_run(
    ...
    """Run an optimization loop over Hope configuration."""
    ...
    if config_path is not None:
        try:
            from hope.learning.optimize.config import load_optimize_config
        except ImportError:
    ...
    if data is not None:
        try:
            from hope.learning.optimize.config import load_benchmark_specs
    ...
    try:
        ...
        from hope.learning.optimize.config import load_objectives
        ...
        try:
            from hope.evals.cli import _build_judge_backend
