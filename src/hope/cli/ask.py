"""``hope ask`` — send a query to the assistant."""
...
from hope.cli._tool_names import resolve_tool_names
from hope.cli.hints import hint_no_engine
...
def ask(
    ...
    if resolved is None:
        console.print(
            ...
            "  [cyan]hope config set engine.ollama.host http://<remote-ip>:11434[/cyan]\n"
