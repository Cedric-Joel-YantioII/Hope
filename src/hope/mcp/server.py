"""MCP Server — wraps Hope tools as MCP-discoverable tools."""
...
class MCPServer:
    """MCP server that exposes Hope tools via JSON-RPC.
    ...
    def _auto_discover_tools() -> List[BaseTool]:
        ...
        try:
            ...
            pass
        try:
            from hope.tools.web_search import WebSearchTool
        ...
        # Channel MCP tools
        try:
            from hope.tools.channel_tools import (
                ChannelListTool,
                ChannelSendTool,
                ChannelStatusTool,
            )
