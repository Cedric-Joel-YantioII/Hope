...
from hope.agents._stubs import AgentContext, BaseAgent
    ...
    async def stream(self) -> AsyncGenerator[str, None]:
        ...
        try:
            ...
            try:
                ...
                logger = logging.getLogger("hope.server")
            ...
            if engine is not None and hasattr(engine, "stream_full") and content:
                ...
                try:
                    from hope.core.types import Message as MsgType
                    from hope.core.types import Role as RoleType
                    ...
                    _logger = _logging.getLogger("hope.server")
                    _logger.warning(
