...
from hope.connectors._stubs import BaseConnector
...
class SyncScheduler:
    ...
    ----------
    sync_engine:
        The :class:`~hope.connectors.sync_engine.SyncEngine` used to
    ...
    def add(self, connector: BaseConnector) -> None:
        ...
        ----------
        connector:
            Any :class:`~hope.connectors._stubs.BaseConnector` instance.
