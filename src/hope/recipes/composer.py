...
if TYPE_CHECKING:
    from hope.evals.core.types import EvalSuiteConfig
    from hope.operators.types import OperatorManifest
    from hope.recipes.loader import Recipe
...
def recipe_to_eval_suite(
    ...
    backend = recipe.eval_backend or ("hope-agent" if has_agent else "hope-direct")
