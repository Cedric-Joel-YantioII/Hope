#!/usr/bin/env python3
"""Index Hope docs (README.md + docs/**/*.md) into a DenseMemory backend.
...
def build_index(
    ...
    *,
    ...
    dedupe: bool = True,
    # Empirical: on the actual Hope docs the boilerplate that
    # crowds retrieval ("Hope runs entirely on your hardware...")
...
def main() -> int:
    ...
    queries = args.query or [
        ...
        "what inference engines does hope support?",
