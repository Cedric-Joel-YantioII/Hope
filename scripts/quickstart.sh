...
uv run maturin develop -m rust/crates/hope-python/Cargo.toml --quiet 2>/dev/null \
...
uv run hope serve --port 8000 &>/dev/null &
CLEANUP_PIDS+=($!)
sleep 3
...
echo ""
echo -e "${GREEN}${BOLD}  Hope is running!${NC}"
echo ""
