...
See the [Savings Leaderboard](https://open-hope.github.io/Hope/leaderboard/) for details.
...
Look for issues labeled [`good-first-issue`](https://github.com/open-hope/Hope/labels/good-first-issue).
...
1. Browse the [Roadmap](https://open-hope.github.io/Hope/development/roadmap/) for an item that interests you
2. Check if a [GitHub issue](https://github.com/open-hope/Hope/issues) already exists for it — if not, [open one](https://github.com/open-hope/Hope/issues/new/choose) describing what you'd like to work on
...
Use the appropriate [issue template](https://github.com/open-hope/Hope/issues/new/choose):
...
- Open a [Discussion](https://github.com/open-hope/Hope/discussions) for questions and help
- Check the [documentation](https://open-hope.github.io/Hope/) for guides and API reference
