"""Tests for hope.optimize.trial_runner module."""

from __future__ import annotations

from unittest.mock import MagicMock, patch

from hope.evals.core.types import RunConfig, RunSummary
from hope.learning.optimize.trial_runner import TrialRunner
from hope.learning.optimize.types import TrialConfig, TrialResult
...
class TestBuildRunConfig:
    ...
    def test_no_agent_maps_to_direct_backend(self) -> None:
        ...
        assert cfg.backend == "hope-direct"
...
class TestRunTrial:
    ...
    @patch("hope.evals.cli._build_scorer")
    @patch("hope.evals.cli._build_judge_backend")
    @patch("hope.evals.cli._build_dataset")
    @patch("hope.evals.cli._build_backend")
    @patch("hope.evals.core.runner.EvalRunner")
    ...
    def test_run_trial_populates_sample_scores(
        ...
        from hope.evals.core.types import EvalResult
