...
class TestGRPOConfig:
    def test_default_config(self) -> None:
        from hope.core.config import GRPOConfig
...
class TestDefaultRewardFn:
    def test_score_returns_float(self) -> None:
        from hope.learning.intelligence.grpo_trainer import DefaultRewardFn
...
class TestGRPOTrainer:
    def test_init(self) -> None:
        from hope.core.config import GRPOConfig
        from hope.learning.intelligence.grpo_trainer import GRPOTrainer
