"""Smoke tests for ``hope optimize`` and ``hope feedback`` CLI commands,
...
class TestOptimizeConfig:
    """Tests for OptimizeConfig in HopeConfig."""

    def test_optimize_config_in_hope_config(self):
        from hope.core.config import HopeConfig, OptimizeConfig
    ...
    def test_optimize_config_defaults(self):
        from hope.core.config import OptimizeConfig
