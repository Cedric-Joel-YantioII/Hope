"""Tests for hope bench skills CLI command (Plan 2B)."""
...
class TestBenchSkillsCommand:
    ...
    def test_runs_all_conditions_with_mocked_runner(self, tmp_path: Path) -> None:
        ...
        with patch(
            "hope.evals.skill_benchmark.SkillBenchmarkRunner.run_all_conditions",
            return_value=fake_cmp,
        ):
            with patch(
                "hope.evals.skill_benchmark.SkillBenchmarkRunner.write_report",
    ...
    def test_runs_single_condition(self, tmp_path: Path) -> None:
        from hope.evals.skill_benchmark import ConditionResult
        ...
        with patch(
            "hope.evals.skill_benchmark.SkillBenchmarkRunner.run_condition",
