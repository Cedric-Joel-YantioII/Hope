"""Tests for the ``hope registry`` CLI commands."""
...
class TestRegistryCmd:
    """Test cases for the hope registry CLI group."""
    ...
    def test_registry_show_handles_exception(self) -> None:
        ...
        with patch(
            "hope.core.registry.ToolRegistry.keys",
    ...
    def test_registry_show_handles_error_during_import(self) -> None:
        ...
        with patch.dict("sys.modules", {"hope.core.registry": None}):
