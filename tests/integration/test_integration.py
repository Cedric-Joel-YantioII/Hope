...
from hope.core.registry import AgentRegistry, RouterPolicyRegistry, ToolRegistry
...
class TestAskFlowWithRouterPolicy:
    ...
    def test_mocked_ask_with_registry_router(self):
        from hope.learning._stubs import RoutingContext
        from hope.learning.routing.heuristic_policy import ensure_registered
        from hope.learning.routing.router import HeuristicRouter
...
class TestSDKImport:
    """Verify Hope class is importable from hope."""

    def test_hope_imports(self):
...
class TestSDKAskFlow:
    ...
    def test_sdk_ask_e2e(self):
        ...
        with patch("hope.sdk.get_engine", return_value=("mock", engine)):
            j = Hope(config=HopeConfig(), model="test-model")
...
class TestSDKMemoryHandle:
    ...
    def test_index_and_search(self, tmp_path):
        from hope.core.config import HopeConfig
        from hope.sdk import MemoryHandle
...
class TestBenchmarkRegistryDiscovery:
    ...
    def test_discovers_benchmarks(self):
        from hope.bench import ensure_registered
...
class TestBenchmarkSuiteRunAll:
    ...
    def test_suite_produces_jsonl(self):
        ...
        from hope.bench import ensure_registered
        from hope.bench._stubs import BenchmarkSuite
        from hope.core.registry import BenchmarkRegistry
...
class TestFullPipeline:
    ...
    def test_full_pipeline(self, tmp_path):
        ...
        from hope.agents._stubs import AgentResult
        from hope.core.config import HopeConfig
        ...
        with patch("hope.sdk.get_engine", return_value=("mock", engine)):
            j = Hope(config=cfg, model="test-model")
