...
- HopeDirectBackend propagates gpu_metrics flag
...
from hope.evals.core.types import EvalResult, RunConfig, RunSummary
...
class TestSummaryToDict:
    ...
    def test_telemetry_summary_present(self):
        from hope.evals.core.runner import _summary_to_dict
...
class TestResultToTraceDict:
    ...
    def test_estimated_flops_in_trace(self):
        from hope.evals.core.runner import _result_to_trace_dict
...
# ---------------------------------------------------------------------------
# HopeDirectBackend gpu_metrics propagation
# ---------------------------------------------------------------------------


class TestDirectBackendGpuMetrics:
    """Verify HopeDirectBackend sets gpu_metrics on config."""

    @patch("hope.system.SystemBuilder")
...
class TestTauBenchTelemetryPassthrough:
    ...
    @patch("hope.evals.execution.taubench_env.TauBenchTaskEnv")
...
class TestExpandSuiteModelMetadata:
    ...
    def test_metadata_includes_params(self):
        from hope.evals.core.config import expand_suite
        from hope.evals.core.types import (
            BenchmarkConfig,
            DefaultsConfig,
            EvalSuiteConfig,
            ExecutionConfig,
