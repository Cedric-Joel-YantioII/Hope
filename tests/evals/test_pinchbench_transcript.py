...
from hope.evals.core.event_recorder import AgentEvent, EventType
from hope.evals.core.trace import TurnTrace
...
def test_events_to_transcript_tool_call_pair():
    ...
    from hope.evals.scorers.pinchbench import events_to_transcript
...
def test_events_to_transcript_tool_name_mapping():
    """Hope tool names are mapped to PinchBench-expected names."""
    from hope.evals.scorers.pinchbench import events_to_transcript
