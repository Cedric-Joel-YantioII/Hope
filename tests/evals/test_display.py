"""Tests for the Rich display helpers in hope.evals.core.display."""
...
from hope.evals.core.types import MetricStats, RunSummary
...
class TestPrintBanner:
    def test_produces_output(self):
        ...
        output = buf.getvalue()
        assert "Hope" in output or "___" in output
