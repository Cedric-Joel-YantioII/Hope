...
def test_returns_tools_from_mcp_server(mock_load_config: MagicMock):
    ...
    with (
        patch("hope.mcp.transport.StreamableHTTPTransport"),
        patch("hope.mcp.client.MCPClient"),
        patch("hope.tools.mcp_adapter.MCPToolProvider") as MockProvider,
    ):
