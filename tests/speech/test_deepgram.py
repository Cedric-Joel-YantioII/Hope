...
from hope.speech.deepgram import DeepgramSpeechBackend
...
def test_deepgram_transcribe():
    ...
    with patch("hope.speech.deepgram.DeepgramClient", return_value=mock_client):
        from hope.speech.deepgram import DeepgramSpeechBackend
...
def test_deepgram_health():
    with patch("hope.speech.deepgram.DeepgramClient"):
        from hope.speech.deepgram import DeepgramSpeechBackend
