...
from hope.speech.openai_whisper import OpenAIWhisperBackend
...
def test_openai_whisper_transcribe():
    ...
    with patch("hope.speech.openai_whisper.OpenAI", return_value=mock_client):
        from hope.speech.openai_whisper import OpenAIWhisperBackend
...
def test_openai_whisper_health():
    with patch("hope.speech.openai_whisper.OpenAI"):
        from hope.speech.openai_whisper import OpenAIWhisperBackend
