...
from hope.tools.shell_exec import ShellExecTool
...
class TestShellExecTool:
    def test_registered_via_tools_package_import(self):
        import hope.tools as tools_pkg
        from hope.core.registry import ToolRegistry

        sys.modules.pop("hope.tools.shell_exec", None)
    ...
    def test_env_passthrough(self):
        ...
        marker = "HOPE_TEST_PASSTHROUGH_67890"
