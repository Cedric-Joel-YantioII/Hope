...
_PATCH_HTTP = "hope.mcp.transport.StreamableHTTPTransport"
_PATCH_STDIO = "hope.mcp.transport.StdioTransport"
_PATCH_CLIENT = "hope.mcp.client.MCPClient"
_PATCH_PROVIDER = "hope.tools.mcp_adapter.MCPToolProvider"
_PATCH_LOGGER = "hope.system.builder.logger"
