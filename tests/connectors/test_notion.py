...
def connector(tmp_path: Path):
    ...
    from hope.connectors.notion import NotionConnector  # noqa: PLC0415
...
@patch("hope.connectors.notion._notion_api_search")
@patch("hope.connectors.notion._notion_api_get_blocks")
...
def test_render_blocks_to_markdown() -> None:
    ...
    from hope.connectors.notion import _render_blocks_to_markdown  # noqa: PLC0415
