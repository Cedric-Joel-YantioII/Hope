...
def connector(tmp_path: Path):
    ...
    from hope.connectors.dropbox import DropboxConnector  # noqa: PLC0415
...
@patch("hope.connectors.dropbox._dropbox_api_list_folder")
@patch("hope.connectors.dropbox._dropbox_api_download")
