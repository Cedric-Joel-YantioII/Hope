...
def connector(tmp_path: Path):
    ...
    from hope.connectors.gmail import GmailConnector  # noqa: PLC0415
...
@patch("hope.connectors.gmail._gmail_api_list_messages")
@patch("hope.connectors.gmail._gmail_api_get_message")
