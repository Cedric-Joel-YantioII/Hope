...
def connector(tmp_path: Path):
    ...
    from hope.connectors.gdrive import GDriveConnector  # noqa: PLC0415
...
@patch("hope.connectors.gdrive._gdrive_api_list_files")
@patch("hope.connectors.gdrive._gdrive_api_export")
