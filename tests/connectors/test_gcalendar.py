...
def connector(tmp_path: Path):
    ...
    from hope.connectors.gcalendar import GCalendarConnector  # noqa: PLC0415

    creds_path = str(tmp_path / "gcalendar.json")
    with patch(
        "hope.connectors.oauth._SHARED_GOOGLE_CREDENTIALS_PATH",
...
@patch("hope.connectors.gcalendar._gcal_api_calendars_list")
@patch("hope.connectors.gcalendar._gcal_api_events_list")
