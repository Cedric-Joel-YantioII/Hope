...
def connector(tmp_path: Path):
    ...
    from hope.connectors.slack_connector import SlackConnector  # noqa: PLC0415
...
@patch("hope.connectors.slack_connector._slack_api_conversations_list")
@patch("hope.connectors.slack_connector._slack_api_conversations_history")
@patch("hope.connectors.slack_connector._slack_api_users_list")
