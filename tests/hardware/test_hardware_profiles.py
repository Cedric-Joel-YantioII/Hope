...
class TestDetectHardware:
    ...
    @patch("hope.core.config.shutil.which", return_value="/usr/bin/nvidia-smi")
    @patch(
        "hope.core.config._run_cmd",
    ...
    @patch("hope.core.config.shutil.which", return_value="/usr/bin/rocm-smi")
    @patch(
        "hope.core.config._run_cmd",
        side_effect=[
    ...
    @patch("hope.core.config.platform.system", return_value="Darwin")
    @patch(
        "hope.core.config._run_cmd",
        return_value=(
            "Graphics/Displays:\n"
    ...
    @patch("hope.core.config.shutil.which", return_value=None)
    @patch("hope.core.config.platform.system", return_value="Linux")
