...
class TestOperativeAgent:
    def test_init_defaults(self):
        ...
        engine = FakeEngine()
        with patch(
            "hope.agents._stubs.load_config",
...
class TestOperatorsConfig:
    def test_config_defaults(self):
        from hope.core.config import OperatorsConfig
    ...
    def test_config_in_hope_config(self):
        from hope.core.config import HopeConfig
...
class TestLoadBundledOperators:
    ...
    def operators_dir(self):
        ...
        ops_dir = project_root / "src" / "hope" / "operators" / "data"
