...
Hope ships with two benchmarks:
...
from hope.bench._stubs import BenchmarkResult
...
from hope.bench.latency import LatencyBenchmark
from hope.bench.throughput import ThroughputBenchmark
...
hope bench run -b throughput -n 20

# Specify model and engine
hope bench run -m qwen3:8b -e ollama

# Output JSON summary to stdout
hope bench run --json

# Write JSONL results to a file
hope bench run -o results.jsonl

# Combine options
hope bench run -b latency -n 100 -m qwen3:8b --json -o latency.jsonl
```
...
```python
import time
from hope.bench._stubs import BaseBenchmark, BenchmarkResult
...
```bash
hope bench run -b context_length
```
