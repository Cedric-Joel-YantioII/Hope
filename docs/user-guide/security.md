...
Hope includes a security layer that scans prompts and model outputs for secrets, personally identifiable information (PII), and sensitive file paths. The system is designed to be composable: scanners run as a pipeline, and the `GuardrailsEngine` wrapper drops in front of any inference backend without changing how the rest of your code works.
...
=== "Warn mode (default)"
    ...
    from hope.security.types import RedactionMode
...
=== "Block mode"
    ...
    from hope.engine.ollama import OllamaEngine
    from hope.security.guardrails import GuardrailsEngine, SecurityBlockError
    from hope.security.types import RedactionMode
    from hope.core.types import Message, Role
...
from hope.security.guardrails import GuardrailsEngine
from hope.security.scanner import SecretScanner
from hope.security.types import RedactionMode
...
from hope.security.scanner import PIIScanner
...
from hope.security.file_policy import is_sensitive_file, filter_sensitive_paths
...
from hope.security.audit import AuditLogger
from hope.security.guardrails import GuardrailsEngine
from hope.security.types import RedactionMode
from hope.engine.ollama import OllamaEngine
...
audit = AuditLogger(db_path="~/.hope/audit.db", bus=bus)
...
import time
from hope.security.audit import AuditLogger
from hope.security.types import SecurityEvent, SecurityEventType
...
audit = AuditLogger(db_path="~/.hope/audit.db")
...
Security settings live in the `[security]` section of `~/.hope/config.toml`.
...
| `audit_log_path` | `str` | `~/.hope/audit.db` | Path to the SQLite audit log |
...
import re
from hope.security._stubs import BaseScanner
from hope.security.types import ScanFinding, ScanResult, ThreatLevel
...
- [API Reference: Security](../api-reference/hope/security/index.md) — full class and function signatures
