---
title: Installation
description: Get Hope running — browser app, desktop app, CLI, or Python SDK
search:
  boost: 3
---
...
| Platform | Download |
|----------|----------|
| macOS (Apple Silicon) | [:material-download: **Hope.dmg**](https://github.com/open-hope/Hope/releases/download/desktop-latest/Hope_0.1.0_aarch64.dmg) |
| Windows (64-bit) | [:material-download: **Hope-setup.exe**](https://github.com/open-hope/Hope/releases/download/desktop-latest/Hope_0.1.0_x64-setup.exe) |
| Linux (DEB) | [:material-download: **Hope.deb**](https://github.com/open-hope/Hope/releases/download/desktop-latest/Hope_0.1.0_amd64.deb) |
| Linux (RPM) | [:material-download: **Hope.rpm**](https://github.com/open-hope/Hope/releases/download/desktop-latest/Hope-0.1.0-1.x86_64.rpm) |
| Linux (AppImage) | [:material-download: **Hope.AppImage**](https://github.com/open-hope/Hope/releases/download/desktop-latest/Hope_0.1.0_amd64.AppImage) |
...
Hope uses optional extras to keep the base installation lightweight.
...
!!! note "Ollama, vLLM, and llama.cpp are HTTP-based"
    These engines have no additional Python dependencies — Hope communicates over HTTP. You still need the engine software running on your machine.
...
| Extra | Install Command | Description |
|-------|----------------|-------------|
| `server` | `uv sync --extra server` | OpenAI-compatible API server (`hope serve`) |
...
Hope requires at least one inference backend. Choose the one that matches your hardware.
