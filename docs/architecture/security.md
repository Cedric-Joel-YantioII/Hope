...
The default path is `~/.hope/audit.db`, configurable via `security.audit_log_path` in `config.toml`.
...
- [API Reference: Security](../api-reference/hope/security/index.md) — complete class and function signatures
