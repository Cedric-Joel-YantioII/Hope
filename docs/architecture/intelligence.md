...
```python
from hope.intelligence import merge_discovered_models
...
The following names are still importable from `hope.intelligence` via shim modules, but their canonical locations have moved:
