...
const OPTIN_KEY = 'hope-desktop-optin';
const OPTIN_NAME_KEY = 'hope-desktop-display-name';
const OPTIN_EMAIL_KEY = 'hope-desktop-email';
const OPTIN_ANONID_KEY = 'hope-desktop-anon-id';
    ...
    <div style={styles.container}>
      ...
      {showOptIn ? (
        ...
        <div style={{ marginBottom: 16, display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <a
            href="https://open-hope.github.io/Hope/leaderboard"
            target="_blank"
